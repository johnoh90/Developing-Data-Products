...
shinyUI(fluidPage(
        ...
        sidebarLayout(
                ...
                mainPanel(
                        ...
                        p('This is an app intended to provide some basic exploratory analysis.'),
                        p("It uses the training dataset on Kaggle's Titanic challenge, which you can download on Kaggle's page:"),
                        h4('Getting Started with this Web App'),
                        p('On the side panel you can change the variables to the plot.'),
